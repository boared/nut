...
class Matrix4x4FloatTest : public ::testing::Test
{
    protected:
...
TEST_F(Matrix4x4FloatTest, constructors)
{
    // Default constructor
    Matrix4x4<FLOAT> m1;
...
TEST_F(Matrix4x4FloatTest, clear)
{
    ...
    for (int i = 0; i < 16; ++i)
    {
        EXPECT_FLOAT_EQ(Matrix4x4<FLOAT>::ZERO[i], m[i]);
    }
}



TEST_F(Matrix4x4FloatTest, setIdentity)
{
    Matrix4x4<FLOAT> m(11, 12, 13, 14,
                      21, 22, 23, 24,
                      31, 32, 33, 34,
...
TEST_F(Matrix4x4FloatTest, determinant)
{
...
TEST_F(Matrix4x4FloatTest, transpose)
{
    // Identity determinant
    Matrix4x4<FLOAT> m(11, 12, 13, 14,
                      21, 22, 23, 24,
...
TEST_F(Matrix4x4FloatTest, constants)
{
    // Identity matrix
    for (int i = 0; i < 16; ++i)
    {
        if (i == 0 || i == 5 || i == 10 || i == 15)
        {
            EXPECT_FLOAT_EQ(1.0f, Matrix4x4<FLOAT>::IDENTITY[i]);
        }
        else
        {
            EXPECT_FLOAT_EQ(0.0f, Matrix4x4<FLOAT>::IDENTITY[i]);
        }
    }
    ...
    for (int i = 0; i < 16; ++i)
    {
        EXPECT_FLOAT_EQ(0.0f, Matrix4x4<FLOAT>::ZERO[i]);
    }
}



TEST_F(Matrix4x4FloatTest, operators)
{
    Matrix4x4<FLOAT> m(11, 12, 13, 14,
                      21, 22, 23, 24,
                      31, 32, 33, 34,
