...
TEST_F(Vector2DDoubleTest, orientedArea)
{
    ...
    EXPECT_NEAR(0.0f, u1.oriArea(u2), 1e-20);
    EXPECT_NEAR(0.0f, u2.oriArea(u1), 1e-20);

    EXPECT_NEAR(0.0f, u3.oriArea(u6), 1e-20);
    EXPECT_NEAR(0.0f, u6.oriArea(u3), 1e-20);

    EXPECT_NEAR(-1.0f, u3.oriArea(u7), 1e-20);
    EXPECT_NEAR(1.0f, u7.oriArea(u3), 1e-20);

    EXPECT_NEAR(1.0f, u6.oriArea(u7), 1e-20);
    EXPECT_NEAR(-1.0f, u7.oriArea(u6), 1e-20);
}
